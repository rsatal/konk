...
echo "=== Direct to tagging-aggregate-api service (K8s format) ==="
curl -sk \
  -H "Authorization: Bearer ${JWT}" \
  "https://tagging-aggregate-api-apiservice.tagging-v2.svc.cluster.local:443/apis/tagging.bulk.infoblox.com/v1alpha1/namespaces/default/tags"
echo ""
echo "EXIT: $?"
